...
@section('page_header')
    <div class="container-fluid">
        ...
        <a href="{{ route('voyager.export-users-log') }}" class="btn btn-success btn-add-new">
                <i class="voyager-plus"></i> <span>Export CSV</span>
            </a>
        @endcan
                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            if($row->display_name =="Status"){
                                               if($data->{$row->field}==1){
                                                $data->{$row->field} ="Login";
                                               }else{
                                                $data->{$row->field} ="Logout";
                                               }
                                            }
                                            ...
                                            <td>
                                                ...
                                                @elseif($row->type == 'image')
                                                    <img src="@if( !filter_var($data->{$row->field}, FILTER_VALIDATE_URL)){{ Voyager::image( $data->{$row->field} ) }}@else{{ $data->{$row->field} }}@endif" style="width:100px;border-radius: 50%;max-width: 45px;">
