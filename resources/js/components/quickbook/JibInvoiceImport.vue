                ...
                submitFile(){ 
                    ...
                    if(this.enterpriseValue && this.companyValue){
                        if(this.file){
                            ...
                            axios.post('/admin/validate_jib_gl_import', formData).then(res => {
                                if(res.data.status){
                                    ...
                                    this.resetField();
                                    if(data){
                                         window.location.href = '/admin/validate_jib_import_list';
                                        //this.$router.push({path: '/admin/validate_jib_import_list'});
                                    }
                                } 
                                else {
                                    toast.fire({
