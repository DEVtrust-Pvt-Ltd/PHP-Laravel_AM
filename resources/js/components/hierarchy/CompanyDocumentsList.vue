...
// console.log(this.$refs.entity_form.$refs);
        ...
        return {
            entity: "companies/" + this.companyId + "/documents",
            fullCategoriesList: [],
        ...
        // $table->string('keywords', 1000)->nullable();
            ...
            url_hash: "#documents",
            add_button_caption: "Add Company Document",
            modal_title: "Edit Document for " + this.$parent.company.name,
        }
    },

    async mounted() {
        this.fullCategoriesList = (await axios.get('/admin/common/api/categories/company_document')).data;
